                            ...
                            cartItems.map((item) => (
                              <div key={item.product} className="cart__items">
                                ...
                                <div className="cart__items-delete">
                                  <span type="button" onClick={() => removeFromCartAction(item.product)}><i className="bi bi-trash" /></span>
                                </div>
                              </div>
                            ))
                        }
                      ...
                      <div className="col-lg-4">
                        <div className="cart__final">
                          ...
                          <div className="cart__final-button">
                            <button type="button" onClick={checkout} disabled={cartItems.length === 0}>
